using JustCSharp.ReportViewer.ASPNet.Utilities;
using System;
using System.Web;
using System.Web.Mvc;

namespace JustCSharp.ReportViewer.ASPNet.Controllers
{
    public abstract class ReportController : Controller
    {
        ...
        public JsonResult ReloadParameters(string reportPath)
        {
            ...
            return Json(HtmlHelperExtensions.ParametersToHtmlString(null, model), JsonRequestBehavior.AllowGet);
        }
        ...
        protected ReportViewerModel GetReportViewerModel(HttpRequestBase request)
        {
            ...
            model.AjaxLoadInitialReport = AjaxLoadInitialReport;
            model.Credentials = NetworkCredentials;
            ...
            model.ServerUrl = ReportServerUrl;
            model.ReportImagePath = ReportImagePath;
            model.Timeout = Timeout;
            model.UseCustomReportImagePath = UseCustomReportImagePath;
